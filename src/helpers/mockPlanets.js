  ...
  results: [
    {
      ...
      films: [
        'https://swapi-trybe.herokuapdfgp.com/api/films/1/',
        'https://swapi-trybe.herokudsapp.com/api/films/3/',
        'https://swapi-trybe.herokdsuapp.com/api/films/4/',
        'https://swapi-trybe.herokudsapp.com/api/films/5/',
        'https://swapi-trybe.herokuadsdpp.com/api/films/6/',
      ],
    ...
    },
    {
      ...
      films: [
        ...
        'https://swapi-trybe.herokuapsdsp.com/api/films/6/',
      ],
    ...
    },
    {
      ...
      residents: [],
      films: [
        'https://swapi-trybe.herokufdfapp.com/api/films/2/',
      ],
    ...
    },
    {
      ...
      residents: [],
      films: [
        'https://swapi-trybe.herokufdapp.com/api/films/2/',
        'https://swapi-trybe.herokufdfapp.com/api/films/3/',
        'https://swapi-trybe.herokufdapp.com/api/films/6/',
      ],
    ...
    },
    {
      ...
      films: [
        'https://swapi-trybe.hefdfrokuapp.com/api/films/3/',
      ],
    ...
    },
    {
      ...
      films: [
        ...
        'https://swapi-trybe.fdfherokuapp.com/api/films/5/',
